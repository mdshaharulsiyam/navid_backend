...
const create_or_update = async (req: Request, res: Response) => {
    ...
    const result = await cart_service.create_or_update(req?.user?._id as string, req?.body?.items)
...
const get_all = async (req: Request, res: Response) => {
    ...
    const result = await cart_service.get_all(queryKeys, searchKeys, populatePath, selectFields, order as string)
...
const update = async (req: Request, res: Response) => {
    ...
    const result = await cart_service.update(req?.params?.id as string, req?.body?.items)
